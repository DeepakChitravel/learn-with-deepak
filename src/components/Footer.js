...
const Footer = () => {
  return (
    <footer className="bg-dark text-white pt-4 mt-5" style={{ position: 'relative', bottom: 0, width: '100%' }}>
      <Container>
        <Row className="text-center text-md-left align-items-start">
          ...
          <Col md={4} className="mb-4">
            ...
            <p className="mb-2">Jeyaram Educational Trust, Thanjavur</p>
            <div style={{ width: "100%", height: "150px", overflow: "hidden", borderRadius: "8px", boxShadow: '0 2px 10px rgba(0,0,0,0.2)' }}>
              <iframe
          ...
          {/* Copyright */}
          <Col md={4} className="d-flex flex-column justify-content-center align-items-center mt-3 mt-md-0">
            <small className="text-white text-center">
              © 2025 Deepak C <br /> Learn With Deepak
            </small>
          </Col>
        </Row>
      </Container>
