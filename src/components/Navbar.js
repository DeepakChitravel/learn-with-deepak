...
// ✅ Chapter arrays should come BEFORE the function
const htmlChapters = [
...
// ✅ Correct placement of getTitleFromPath
const getTitleFromPath = (pathname) => {
  ...
  const matched = allChapters.find((chap) => pathname === chap.path);
  return matched ? matched.name : 'My Web Learning App';
};
...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    document.title = `${title} | My Web Learning App`;
  }, [location.pathname]);
  ...
  const renderChapters = () => {
    const chapters =
      selectedLang === 'HTML'
        ...
        : selectedLang === 'CSS'
        ? cssChapters
        : selectedLang === 'Fundamentals'
        ? fundamentalsChapters
        : selectedLang === 'MS Office'
        ? msofficeChapters
        : selectedLang === 'C'
        ? cChapters
        : [];
